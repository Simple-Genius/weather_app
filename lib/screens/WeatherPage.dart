                        ...
                        IconButton(
                            onPressed: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => FutureWeatherPage(
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          WeatherCard(
                            ...
                            temperature: snapshot.data!.futureTemperatureList[1]
                                .ceil()
                                .toString(),
                            time: snapshot.data!.dates[1].split(' ')[1],
                            imgUrl: snapshot.data!.images[1],
                          ),
                          WeatherCard(
                              date: snapshot.data!.dates[2].split(' ')[0],
                              temperature: snapshot
                                  .data!.futureTemperatureList[2]
                                  .ceil()
                                  .toString(),
